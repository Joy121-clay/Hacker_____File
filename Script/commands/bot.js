...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "joy") || (event.body.toLowerCase() == "joy bai") || (event.body.toLowerCase() == "@Ullash ッ") || (event.body.toLowerCase() == "উল্লাস")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ JOY▁▁▁▁▁▁🩵🍃🦋🪽🩷🌸 ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 joy.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/sparsahina.anubhuti.37757\nতার সাতে যোগা যোগ করবেন WhatsApp :- +0175570***", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "sala ami tor boss") || (event.body.toLowerCase() == "sala ami joy") || (event.body.toLowerCase() == "cup sala ami ullash") || (event.body.toLowerCase() == "madari")) {
  ...
  if ((event.body.toLowerCase() == "pran") || (event.body.toLowerCase() == "anu")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস জয় এর বউ এর নাম..!👊🏻😾🍓", threadID);
   };
  
  if ((event.body.toLowerCase() == "aru") || (event.body.toLowerCase() == "Afnan")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস জয় এর বউ এর নাম..!👊🏻😾🍓", threadID);
   };

  if ((event.body.toLowerCase() == "Flarin") || (event.body.toLowerCase() == "Mishu")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস জয় এর কিউটি বোন এর নাম..!😾😍🥳", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "@MD Shiam Tafeder ") || (event.body.toLowerCase() == "সিয়াম")) {
   ...
   if ((event.body.toLowerCase() == "হুম") || (event.body.toLowerCase() == "Hum")) {
     return api.sendMessage("️হুম মারাইস না মাথা এমনিতেই গরম আছে👊🏻😾💥", threadID);
   };
